...
class adLDAP {
    ...
    * @var string
    */
    protected $baseDn = "DC=cobre,DC=pucobre,DC=cl"; 
    ...
    * @var array
    */
    protected $domainControllers = array("puc-dc-02-01.cobre.pucobre.cl");   
    ...
    * @var string
    */
    protected $adminUsername = NULL; //Ideal NOT NULL
    protected $adminPassword = NULL; //ideal Not NULL
